...
public static class Radical
{
	...
	public static GameObject Instantiate(Transform template, GameObject parent = null)
	{
	...
	public static GameObject SetParent(this GameObject child, GameObject parent, bool setScale = false)
	{
		child.transform.SetParent(parent.transform, setScale);
		return child;
	}
	
	public static Transform SetParent(this Transform child, GameObject parent, bool setScale = false)
	{
		child.SetParent(parent.transform, setScale);
		return child;
	}
	
	public static Transform SetParent(this Transform child, Transform parent, bool setScale = false)
	{
		try
		{
